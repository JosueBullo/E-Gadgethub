...
<head>
    ...
    <style>
        ...
        .container.shift {
            margin-left: 250px; /* Adjust this value based on your panel width */
...
<body>
    ...
    <script>
        $(document).ready(function() {
            // Function to toggle the shift class on container
            function toggleShift() {
                $('#categoryContainer').toggleClass('shift');
            }
            ...
            // Toggle shift on panel show/hide
